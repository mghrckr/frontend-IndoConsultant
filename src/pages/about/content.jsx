        ...
        <div className="row gy-4 justify-content-center">
          <div className="col-lg-12">
            <div className="about-content-wrap">
              ...
              <p className="wow fadeInUp" data-wow-delay=".3s">
                Indo Consultant telah didirikan untuk menyediakan{" "}
                <i>Enviromental Services</i> untuk perusahaan anda dengan
                menyediakan jasa-jasa lingkungan sebagai satu paket jasa dari
                berbagai macam jasa lingkungan yang ditawarkan.
              </p>
              <p className="wow fadeInUp" data-wow-delay=".3s">
